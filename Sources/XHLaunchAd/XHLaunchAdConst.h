...
#define XH_FULLSCREEN [XHLaunchAdConst iPhoneX]

#define XH_KEYWINDOW [XHLaunchAdConst getKeyWindow]

#define XH_SAFEAREAINSETS XH_KEYWINDOW.safeAreaInsets
...
@interface XHLaunchAdConst : NSObject
